...
public class QueueBuilder {
    ...
    public QueueBuilder(HBox parent) {
        this.parent = parent;
    }
    
    //START QUEUE CONTENT
    /**
     * Build grid queue content
     * @param list
     * @return content multiple rows
     */
    public GridPane buildQueue(List<Video> list){
    ...
    private JFXButton queueButton(Video v){
        Image img = null;
        try {
